...
#Parameters: {'bootstrap': False, 'min_samples_leaf': 3, 'min_samples_split': 2, 'criterion': 'entropy', 'max_features': 9, 'max_depth': None}

#Model with rank: 2
#Mean validation score: 0.986 (std: 0.010)
#Parameters: {'bootstrap': True, 'min_samples_leaf': 2, 'min_samples_split': 10, 'criterion': 'entropy', 'max_features': 16, 'max_depth': None}

#Model with rank: 3
#Mean validation score: 0.986 (std: 0.012)
#Parameters: {'bootstrap': False, 'min_samples_leaf': 7, 'min_samples_split': 2, 'criterion': 'entropy', 'max_features': 2, 'max_depth': None}

rf=RandomForestClassifier(n_estimators=500)
rf=RandomForestClassifier(criterion='entropy', max_depth=None, min_samples_split=2, 
                       min_samples_leaf=3,max_features=9,bootstrap=False,random_state=1234)
...
res=['Y' if x >= 0.066667 else 'N' for x in test_prob1]
...
#PU_score 10.9168607315
#f1 score 0.77 recall .68 roc .793975943647 brier .44984845127
...
#RandomizedSearchCV took 5384.84 seconds for 20 candidates parameter settings.
#Model with rank: 1
#Mean validation score: 0.977 (std: 0.022)
#Parameters: {'bootstrap': False, 'min_samples_leaf': 4, 'min_samples_split': 3, 'criterion': 'entropy', 'max_features': 4, 'max_depth': None}

#Model with rank: 2
#Mean validation score: 0.974 (std: 0.023)
#Parameters: {'bootstrap': False, 'min_samples_leaf': 6, 'min_samples_split': 5, 'criterion': 'entropy', 'max_features': 19, 'max_depth': None}

#Model with rank: 3
#Mean validation score: 0.971 (std: 0.019)
#Parameters: {'bootstrap': False, 'min_samples_leaf': 5, 'min_samples_split': 9, 'criterion': 'gini', 'max_features': 13, 'max_depth': None}

rf=RandomForestClassifier(n_estimators=500)
rf=RandomForestClassifier(criterion='entropy', max_depth=None, min_samples_split=5, 
                       min_samples_leaf=6,max_features=19,bootstrap=False,random_state=1234)
...
test_prob = rf.predict_proba(test_std)
test_prob1=test_prob[:,1]
res=['Y' if x >= 0.081039 else 'N' for x in test_prob1]
res1=pd.DataFrame(res)
columns=["res"]
res1.columns=columns
test_prob1=pd.DataFrame(test_prob1)
...
#PU_score 11.1970755587
#f1 score .74 recall .62 roc 0.805865674287 brier .46319655186
